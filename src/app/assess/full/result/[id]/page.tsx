        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-6">
              <span className="material-symbols-outlined text-[24px] text-primary">sentiment_satisfied</span>
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {categoryEntries.map(([key, category]) => {
                  const iconName = categoryIconNames[key] || "activity_zone";
