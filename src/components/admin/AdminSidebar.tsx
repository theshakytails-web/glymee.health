...
const navItems = [
  ...
  { label: "Report History", href: "/g9x2k7m3q8w-admin/reports/history", icon: "history" },
  { label: "Diet Plan History", href: "/g9x2k7m3q8w-admin/reports/diet-history", icon: "restaurant_menu" },
